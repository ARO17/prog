/*
 * kms_drm.c -- low-level display graphics with kms/drm 
 * 
 * Written by Harold André
 * E-mail     <harold.andre@gmx.fr>
 * 
 * Started on  Fri Jan  2 15:18:35 2015 Harold André
 * Last update Fri Jan  2 15:49:33 2015 Harold André
 *
 * gcc -Wall -o kms_drm kms_drm.c
 * 
 */
