...
static const yytype_int8 yyrhs[] =
{
      ...
      17,    12,    -1,    18,    12,    -1,    12,    -1,     1,    -1,
      18,     8,     4,    -1,    18,     8,     4,     7,     5,    -1,
      18,     8,     5,     7,     4,    -1,    18,     8,     9,     3,
      -1,    18,     8,     9,     3,     7,    10,     3,    -1,    18,
       8,    10,     3,     7,     9,     3,    -1,    19,    20,    -1,
       3,    -1,     3,     6,     3,    -1,     3,     6,     3,     6,
       3,    -1,    11,     3,    -1,    11,     3,     6,     3,    -1,
      11,     3,     6,     3,     6,     3,    -1
};
...
{
       0,    43,    43,    46,    47,    50,    61,    66,    67,    76,
      88,   101,   114,   126,   139,   153,   157,   165,   174,   186,
     194,   203
};
#endif
...
{
  "$end", "error", "$undefined", "NUMBER", "CAPSID", "GROUPID", "COLON",
  "COMMA", "ASSIGN", "CAPSULE", "GROUP", "TIMESEPARATOR", "EOL", "$accept",
  "config_file", "lines", "one_line", "Command", "Time", "StartTime",
  "EndTime", 0
};
#endif
...
{
       0,     8,    16,     7,     0,     2,     0,     0,     0,     0,
       0,     1,     3,     5,     0,     6,     0,    15,    17,     9,
       0,     0,     0,    19,     0,     0,     0,    12,     0,     0,
      18,    10,    11,     0,     0,    20,     0,     0,     0,    13,
      14,    21
};
...
{
       1,    -8,     2,    -8,     6,    -8,     0,    -7,    -1,     7,
      13,    -8,    -8,    -8,     5,    -8,    14,    -8,    15,    12,
      16,    17,    19,    18,    22,    21,    23,    24,    25,    26,
      -8,    -8,    -8,    20,    27,    28,    30,    32,    34,    -8,
      -8,    -8
};
...
{
      -4,     1,     1,     2,     2,    13,    11,    14,    10,    19,
      20,    15,     3,     3,    21,    22,    18,    23,    16,    25,
      27,    24,    28,    26,    29,    30,    31,    32,     0,    35,
      36,    33,    34,    39,    38,    40,    37,    41,     0,    12
};
...
{
       0,     1,     1,     3,     3,    12,     0,     8,     6,     4,
       5,    12,    12,    12,     9,    10,     3,     3,    11,     7,
       3,     6,     3,     7,     6,     3,     5,     4,    -1,     3,
      10,     7,     7,     3,     6,     3,     9,     3,    -1,     6
};
...
{
       0,     1,     3,    12,    14,    15,    16,    17,    18,    19,
       6,     0,    15,    12,     8,    12,    11,    20,     3,     4,
       5,     9,    10,     3,     6,     7,     7,     3,     3,     6,
       3,     5,     4,     7,     7,     3,    10,     9,     6,     3,
       3,     3
};
...
/* Line 1806 of yacc.c  */
#line 77 "sts_parser.y"
    {{
	if ((cmd_line.fragrance = atoi((yyvsp[(3) - (3)].string)+1)) > 4) {
...
/* Line 1806 of yacc.c  */
#line 89 "sts_parser.y"
    {{
	if ((cmd_line.fragrance = atoi((yyvsp[(3) - (5)].string)+1)) > 4) {
	  yyerror("Fragrance value must be >=0 and <=4\n");
	  YYERROR;
	} else {
	cmd_line.group = atoi((yyvsp[(5) - (5)].string)+1);
#ifdef DEBUG
...
/* Line 1806 of yacc.c  */
#line 102 "sts_parser.y"
    {{
	if ((cmd_line.fragrance = atoi((yyvsp[(5) - (5)].string)+1)) > 4) {
	  yyerror("Fragrance value must be >=0 and <=4\n");
	  YYERROR;
	} else {
	cmd_line.group = atoi((yyvsp[(3) - (5)].string)+1);
#ifdef DEBUG
...
/* Line 1806 of yacc.c  */
#line 115 "sts_parser.y"
    {{
	if ((cmd_line.fragrance = (yyvsp[(4) - (4)].integer)) > 4) {
	  yyerror("Fragrance value must be >=0 and <=4\n");
	  YYERROR;
	} else {
#ifdef DEBUG
...
/* Line 1806 of yacc.c  */
#line 127 "sts_parser.y"
    {{
	if ((cmd_line.fragrance = (yyvsp[(4) - (7)].integer)) > 4) {
	  yyerror("Fragrance value must be >=0 and <=4\n");
	  YYERROR;
	} else {
	cmd_line.group = (yyvsp[(7) - (7)].integer);
#ifdef DEBUG
	printf("DEBUG: fragrance format F*: %d, group format G*: %d\n", cmd_line.fragrance, cmd_line.group);
#endif
	}
...
/* Line 1806 of yacc.c  */
#line 140 "sts_parser.y"
    {{
	if ((cmd_line.fragrance = (yyvsp[(7) - (7)].integer)) > 4) {
	  yyerror("Fragrance value must be >=0 and <=4\n");
	  YYERROR;
	} else {
	cmd_line.group = (yyvsp[(4) - (7)].integer);
#ifdef DEBUG
	printf("DEBUG: group format F*: %d, fragrance format G*: %d\n", cmd_line.group, cmd_line.fragrance);
#endif
	}
...
/* Line 1806 of yacc.c  */
#line 158 "sts_parser.y"
    {{
	cmd_line.start_time.seconde = (yyvsp[(1) - (1)].integer);
#ifdef DEBUG
...
/* Line 1806 of yacc.c  */
#line 166 "sts_parser.y"
    {{ 
	cmd_line.start_time.minute = (yyvsp[(1) - (3)].integer);
	cmd_line.start_time.seconde = (yyvsp[(3) - (3)].integer);
#ifdef DEBUG
...
/* Line 1806 of yacc.c  */
#line 175 "sts_parser.y"
    {{ 
	cmd_line.start_time.hour = (yyvsp[(1) - (5)].integer);
	cmd_line.start_time.minute = (yyvsp[(3) - (5)].integer);
	cmd_line.start_time.seconde = (yyvsp[(5) - (5)].integer);
#ifdef DEBUG
...
/* Line 1806 of yacc.c  */
#line 187 "sts_parser.y"
    {{
	cmd_line.end_time.seconde = (yyvsp[(2) - (2)].integer);
#ifdef DEBUG
...
/* Line 1806 of yacc.c  */
#line 195 "sts_parser.y"
    {{ 
	cmd_line.end_time.minute = (yyvsp[(2) - (4)].integer);
	cmd_line.end_time.seconde = (yyvsp[(4) - (4)].integer);
#ifdef DEBUG
...
/* Line 1806 of yacc.c  */
#line 204 "sts_parser.y"
    {{ 
	cmd_line.end_time.hour = (yyvsp[(2) - (6)].integer);
	cmd_line.end_time.minute = (yyvsp[(4) - (6)].integer);
	cmd_line.end_time.seconde = (yyvsp[(6) - (6)].integer);
#ifdef DEBUG
