...
EndTime:
    ...
    ;
    | DASH NUMBER COLON NUMBER COLON NUMBER
    {{ 
...
void initCommandLine(Command_line *cmd_line) {
  ...
  cmd_line->end_time.hour = -1;
  cmd_line->end_time.minute = -1;
  cmd_line->end_time.seconde = -1;
