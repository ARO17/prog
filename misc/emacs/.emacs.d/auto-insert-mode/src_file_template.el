;;
;; src_file_template.el -- Template header for source code files
;; 
;; Written by Harold André
;; E-mail     <harold.andre@scentys.com>
;; 
;; Started on  Sat Jun 15 11:24:50 2013 Harold André
;; Last update Sat Jun 15 11:27:10 2013 Harold André
;; 
;; From original: http://epitips.bigis.fr/archives/5
;;
...
(setq header-made-by	"Written by "
      header-email	"E-mail     "
      header-email-beg	"<"
      header-email-end	">"
...
(defun std-file-header ()
  ...
  (let ((description "toto"))
    (setq description (read-from-minibuffer
		    (format "Type short description (RETURN to leave empty) : ")))
